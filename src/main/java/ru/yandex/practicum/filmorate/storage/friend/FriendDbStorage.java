...
public class FriendDbStorage implements FriendStorage {
    ...
    public void addFriend(long userId, long friendId) {
        ...
        if (userId == friendId) {
            throw new DuplicatedDataException("Нельзя добавить самого себя в друзья");
        }
    ...
    public boolean confirmFriendShip(long userId, long friendShipRequestUserId) {
        ...
        if (!userStorage.isUserExist(friendShipRequestUserId)) {
            ...
            throw new ResourceNotFoundException("Пользователь с id = " + friendShipRequestUserId + " не найден");
        }
